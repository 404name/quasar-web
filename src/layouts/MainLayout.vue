<template>
  <q-layout class="bg-grey-1">
    <q-header elevated class="text-accent" style="background: #6b9bb8" height-hint="61.59">
      <q-toolbar class="q-py-sm q-px-md">
        <q-btn round dense flat :ripple="false" :icon="fabGithub" size="19px" color="accent" class="q-mr-sm" no-caps />
        <q-select
          ref="search" dark dense standout use-input hide-selected
          class="GL__toolbar-select"
          color="accent" :stack-label="false" label="Search or jump to..."
        ...
        <div v-if="$q.screen.gt.sm" class="GL__toolbar-link q-ml-xs q-gutter-md text-body2 text-weight-bold row items-center no-wrap">
          <router-link to="register" class="text-accent">注册</router-link>
          <router-link to="login" class="text-accent">登录</router-link>
