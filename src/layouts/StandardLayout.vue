<template>
  <q-layout :view="view"
    ...
    <q-header class="bg-white title-grey-8 shadow-1 sc-design"
              height-hint="64"
      ...
      <q-toolbar class="GNL__toolbar">
        ...
        <div class="q-gutter-xs"
          ...
          <q-btn type="a"
            ...
            <q-avatar size="sm">
              <q-img alt="GreaterWMS"
                     src="imgs/logo/cc-admin-logo.png"
                     style="width: 32px" />
              <q-tooltip>
          ...
          <q-btn type="a"
            ...
            <q-avatar size="sm">
              <q-img alt="GreaterWMS"
                     src="imgs/logo/greater-wms-logo.png" />
              <q-tooltip>
      ...
      <div class="absolute-top bg-white q-mt-sm"
        ...
        <div class="bg-transparent q-px-sm q-gutter-x-sm">
          <q-avatar class="q-mb-sm">
            <q-img style="width: 40px"
                   src="imgs/logo/sika-logo.png" />
          </q-avatar>
      ...
      <q-scroll-area class="fit"
        ...
        <div class="q-pa-sm">
          <q-list padding>
              ...
              <q-item-section>
                ...
                <q-item-label>
                  <div class="q-mt-sm q-gutter-x-md row"
                       style="height: 50px">
                    <div class="col-auto shadow-1 cursor-pointer"
                         style="
                        width: 50px;
                        height: 100%;
              ...
              <q-item-section>
                ...
                <q-item-label caption>
                  <div class="q-mt-sm q-gutter-x-md"
                       style="height: 50px">
                    <div class="inline-block shadow-1 cursor-pointer"
                         style="
                        width: 50px;
                        height: 100%;
                        background-color: white;
            ...
            <q-separator spaced="“12px" />
            <q-item>
              <div class="row q-pa-md cursor-pointer"
                   style="
            ...
            <q-item tag="label">
              <q-btn :label="$t('StandardLayout.copySetting')"
                     class="full-width"
                     outline
                     color="secondary"
    ...
    <q-page-container>
      <q-page :class="{
        ...
        <q-page-sticky v-if="styleSettingsData.contentSettings.topBar"
                       expand
                       position="top"
                       style="z-index: 2000"
              ...
              <div v-for="(tab, index) in tabs"
                ...
                <q-tab :ripple="false"
                  ...
                  <q-icon size="18px"
                          name="refresh"
                          class="q-mx-xs"
                          @click="refresh"></q-icon>
                  <q-icon v-if="tab.to !== '/dashboard/analysis'"
                          size="18px"
                          name="close"
                          @click.stop="removeTab(index)"></q-icon>
                </q-tab>
              </div>
            </q-tabs>
          </q-toolbar>
        ...
        <q-page-sticky position="top-right"
          ...
          <q-btn v-touch-pan.prevent.mouse="moveLink"
                 :disable="draggingLink"
                 type="a"
                 target="_blank"
                 unelevated
                 dense
...
import ColorChecked from 'components/layout/ColorChecked'
import LAYOUT_DATA from '../mock/layoutData'
...
export default {
  ...
  methods: {
    ...
    changeColor(val) {
      colors.setBrand('primary', val.color)
    },
    look(type, index) {
      if (type === 'inform') {
    ...
    rightHide() {
      ...
      this.rightOffset = [LAYOUT_DATA.rightOffset.rightOffsetInit[0], tempY]
      this.rightDrawerSetting = false
    },
    rightShow() {
      const tempY = this.rightOffset[1]
      this.rightOffset = [LAYOUT_DATA.rightOffset.rightOffsetShow[0], tempY]
    },
    onResize(size) {
      // 监听容器大小变化
      ...
      copyToClipboard(qq)
        .then(() => {
          this.$q.notify({
            ...
            position: 'top',
            message:
              `${this.$t('StandardLayout.successfulCopyQqGroupNumber')}：` + qq,
          })
        })
        .catch(() => {
          // 失败
    ...
    moveSetting(ev) {
      ...
      this.rightOffset = [this.rightOffset[0], this.rightOffset[1] + ev.delta.y]
    },
  },
  watch: {
    gtSm: function () {
