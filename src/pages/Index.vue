    ...
    <div class="bg-white q-pa-md">
      ...
      <div class="row items-center q-gutter-y-sm">
        <div class="col-sm-auto col-xs-12">
          <q-avatar size="76px">
            <q-img ratio="1"
                   :src="workplaceSata.currentUserData.headSrc" />
          </q-avatar>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-6 q-pl-md">
          ...
          <q-item-label class="text-grey-6 text-body">{{ workplaceSata.currentUserData.job }} |
            {{ workplaceSata.currentUserData.department }}
          </q-item-label>
        </div>
        <div class="col-xs-12 col-md-5 text-grey-6 text-body q-gutter-x-lg"
             :class="{
          ...
          <q-item-label class="inline-block">
            ...
            <q-item-label class="text-center text-black q-pt-xs"
                          style="font-size: x-large">{{ workplaceSata.statisticsData.projectNum }}
            </q-item-label>
          </q-item-label>
          <q-item-label class="inline-block">
            <q-item-label>
              <q-avatar color="orange-1"
                        size="sm"
                        text-color="orange"
                        class="q-mr-sm"
                        icon="edit"></q-avatar>
            ...
            <q-item-label class="text-center text-black q-pt-xs"
                          style="font-size: x-large">{{ workplaceSata.statisticsData.waitMatterNum }}/{{
          ...
          <q-item-label class="inline-block">
            <q-item-label>
              <q-avatar color="green-1"
                        size="sm"
                        text-color="green"
                        class="q-mr-sm"
                        icon="visibility"></q-avatar>
              <span>项目访问</span>
            </q-item-label>
            <q-item-label class="text-center text-black q-pt-xs"
                          style="font-size: x-large">
              {{
                workplaceSata.statisticsData.projectVisitNum
              }}
            </q-item-label>
          </q-item-label>
        </div>
    ...
    <div class="q-mt-md row q-px-sm">
      <div class="col-lg-8 col-xs-12 q-mb-md q-px-sm">
        <q-card flat
          ...
          <div class="row q-pa-sm">
            <div class="col-xs-12 col-md-4 col-sm-6 q-pa-sm cursor-pointer"
        ...
        <q-card flat
                class="no-border-radius q-mt-md q-pb-md">
          <q-card-section class="bg-white">
            <q-avatar color="purple-1"
                      size="sm"
                      text-color="purple"
                      class="q-mr-sm"
                      icon="highlight"></q-avatar>
            <span> 动态 </span>
          </q-card-section>
          <q-separator />
          <q-list>
            <div v-for="(dynamicData, index) in workplaceSata.dynamicDatas"
                 :key="index"
                 class="q-mb-sm">
      ...
      <div class="col-lg-4 col-xs-12 q-px-sm">
        ...
        <q-card flat
          ...
          <q-separator />
          <q-table :data="workplaceSata.waitMatters.waitMatterDatas"
                   :columns="workplaceSata.waitMatters.waitMatterColumns"
                   row-key="id"
                   selection="multiple"
                   color="primary"
                   v-model:selected="workplaceSata.waitMatters.selected"
                   hide-pagination>
...
const itemDefault = {
  src: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1604435817316&di=acd6edbc1c306906444d22cfa51bccb4&imgtype=0&src=http%3A%2F%2Fpic1.win4000.com%2Fpic%2Ff%2F33%2F648011013.jpg',
  select: false,
}
const itemsInit = []
for (let i = 0; i < 6; ++i) {
