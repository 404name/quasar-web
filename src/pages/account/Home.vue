<template>
  <div class="row q-px-sm">
    <div class="col-md-4 col-xs-12 q-px-sm">
      <q-card flat
              class="bg-white no-border-radius">
        <q-card-section class="text-center">
          <q-img :src="accountCenterData.introduceData.imgSrc"
                 style="max-width: 140px"></q-img>
          <q-item-label class="q-my-sm"><strong>{{
    ...
    <div class="col-md-8 col-xs-12 q-px-sm">
      ...
      <q-separator />
      <q-tab-panels v-model="centerTab"
                    animated
                    transition-prev="fade"
                    transition-next="fade">
        <q-tab-panel name="titles"
                     class="q-px-sm q-pt-none">
          <sc-page :items="articlesData.articlesDatas"
                   class="q-mt-sm">
        ...
        <q-tab-panel name="applications"
                     class="q-px-sm q-pt-none">
          <sc-page :items="applicationsData.applicationsDatas"
                   class="q-mt-sm"
        ...
        <q-tab-panel name="projects"
                     class="q-px-sm q-pt-none">
          <sc-page :items="projectsData.projectDatas"
                   class="q-mt-sm"
                   item-class="col-xl-3 col-sm-4 col-xs-12">
            <template v-slot:item="props">
              <q-intersection once
                ...
                <sc-shadow>
                  <q-card square
                          ...
                          flat
                          class="q-pb-sm">
                    <q-img :src="props.item.pictureSrc"
                           :ratio="16 / 10" />
