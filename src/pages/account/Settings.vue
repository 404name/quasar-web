      ...
      <q-card-section class="q-pa-none q-py-md row">
        <div class="col-sm-2 col-xs-12 q-pb-sm">
          <q-tabs v-model="settingsTab"
                  ...
                  class="text-grey-10"
                  vertical>
            <q-tab name="basicSettings"
                   label="基本设置"
                   style="justify-content: left"
                   content-class="q-pl-md" />
            <q-tab name="safeSettings"
                   label="安全设置"
                   style="justify-content: left"
                   content-class="q-pl-md" />
            <q-tab name="accountBind"
                   label="账号绑定"
                   style="justify-content: left"
                   content-class="q-pl-md" />
            <q-tab name="newMsg"
        ...
        <div class="col-sm col-xs-12 q-px-md q-pt-none">
          <q-tab-panels v-model="settingsTab"
            ...
            <q-tab-panel name="basicSettings"
                         class="row q-pt-sm">
              ...
              <q-list class="text-body2">
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">当前密码强度：强
                    </q-item-label>
                  </q-item-section>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">{{ accountSettingsData.safeData.passwordQuestion }}
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-btn flat
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">未绑定 MFA 设备，绑定后，可以进行二次确认
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-btn flat
              ...
              <q-list class="text-body2">
                <q-item>
                  ...
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">{{ accountSettingsData.accountBindData.bindTaoBaoNo }}
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-btn flat
                ...
                <q-item>
                  ...
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">{{ accountSettingsData.accountBindData.bindWechatNo }}
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-btn flat
            ...
            <q-tab-panel name="newMsg">
              ...
              <q-list class="text-body2">
                <q-item>
                  <q-item-section>
                    <q-item-label>账户密码</q-item-label>
                    <q-item-label class="text-grey-6">其他用户的消息将以站内信的形式通知
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-toggle v-model="accountSettingsData.newMsgData.passwordMsg"
                              checked-icon="check"
                              color="primary"
                ...
                <q-item>
                  ...
                  <q-item-section avatar>
                    <q-toggle v-model="accountSettingsData.newMsgData.systemMsg"
                              checked-icon="check"
                              color="primary"
                              unchecked-icon="clear" />
                  </q-item-section>
                ...
                <q-item>
                  <q-item-section>
                    ...
                    <q-item-label class="text-grey-6">待办任务将以站内信的形式通知
                    </q-item-label>
                  </q-item-section>
                  <q-item-section avatar>
                    <q-toggle v-model="accountSettingsData.newMsgData.waitTaskMsg"
                              checked-icon="check"
                              color="red"
                              unchecked-icon="clear" />
                  </q-item-section>
