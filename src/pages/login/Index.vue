<template>
  ...
  <div class="flex justify-center items-center" style="height: 100vh">
    <div class="col-12 flex justify-center items-center" style="height: 30vh" v-show="!$q.screen.gt.sm">
        <lottie-web-cimo align="right" :path="defaultOptions.path" style="height: 30vh" @isLottieFinish="handleFinish"/>
    </div>
    <div class="row base-card-shadow" style="width: 60vw;min-width: 300px;height: 70vh">
      ...
      <div class="col flex justify-center items-center">
        <q-card square style="min-width: 290px;height: 100%; width: 100%;" class="no-shadow">
