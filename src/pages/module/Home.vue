      ...
      <div class="col-md-3 col-xs-6 text-center q-px-sm q-pb-md">
        <sc-shadow>
          <q-card flat square class="q-pa-md">
            ...
            >
              <strong>{{
                monitorData.visitNumData.visitTotal
              }}</strong>
            </q-item-label>
      ...
      <div class="col-md-3 col-xs-6 text-center q-px-sm q-pb-md">
        <sc-shadow>
          <q-card flat square class="q-pa-md">
            ...
            >
              <strong>
                {{ monitorData.pointNumData.pointTotalNum }}
              </strong>
            </q-item-label>
            ...
            <q-item-label class="text-green">
              ...
              ></q-avatar>
              <strong>{{
                monitorData.pointNumData.upRate 
              }}</strong>
            </q-item-label>
          </q-card>
        </sc-shadow>
      ...
      <div class="col-md-3 col-xs-6 text-center q-px-sm q-pb-md">
        <sc-shadow>
          <q-card flat square class="q-pa-md">
            ...
            >
              <strong>{{
                monitorData.arrivalNumData.arrivalTotalNum
              }}</strong>
            </q-item-label>
            <q-item-label caption class="q-mb-sm">
              到达量（近30天）
            ...
            <q-item-label class="text-negative">
              ...
              ></q-avatar>
              <strong>{{
                monitorData.arrivalNumData.upRate
              }}</strong>
            </q-item-label>
          </q-card>
        </sc-shadow>
      ...
      <div class="col-md-3 col-xs-6 text-center q-px-sm q-pb-md">
        <sc-shadow>
          <q-card flat square class="q-pa-md">
            ...
            >
              <strong>{{
                monitorData.conversionData.conversionRate 
              }}</strong>
            </q-item-label>
            <q-item-label caption class="q-mb-sm">
              转化率（近30天）
            ...
            <q-item-label class="text-green">
              ...
              ></q-avatar>
              <strong>{{
                monitorData.conversionData.upRate
              }}</strong>
            </q-item-label>
          </q-card>
        </sc-shadow>
